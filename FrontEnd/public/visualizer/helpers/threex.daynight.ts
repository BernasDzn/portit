...
THREEx.DayNight.StarField	= function(){
	// create the mesh
	var texture	= new THREE.TextureLoader().load('/visualizer/textures/galaxy_starfield.png')
    ...
    this.update = function(sunAngle, cameraPosition){
        mesh.position.copy(cameraPosition); // always centered on camera
