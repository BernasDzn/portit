...
public class QualificationIntegrationTest
{
    ...
    public async Task AddQualification_ReturnsCreatedQualification()
    {
        ...
        var result = await _service.Add(qualificationDto);

        Assert.Equal(qualificationDto.IdCode, result.IdCode);
        Assert.Equal(qualificationDto.QualificationName, result.QualificationName);
    }
    ...
    public async Task UpdateQualification_ReturnsUpdatedQualification()
    {
        ...
        var result = await _service.Update(qualificationDto.IdCode, qualificationDto);
